...
public class Person {
    ...
    public boolean addPerson() {
        ...
        // at least two special characters between characters 3 and 8,
        // and the last two characters should be upper case letters (A - Z). Example:
        // "56s_d%&fAB"
        // Condition 2: The address of the Person should follow the following format:
        // Street Number|Street|City|State|Country.
        // The State should be only Victoria. Example: 32|Highland
        ...
        // other conditions you may want to consider,
    ...
    public boolean updatePersonalDetails(String newID, String newFirstName, String newLastName, String newAddress,
            String newBirthdate) {
        ...
        // considered and checked in the updatePersonalDetails function.
        ...
        // Otherwise, the Person's updated information should not be updated in the TXT
        // file, and the updatePersonalDetails function should return false
        ...
        if (changeBirthday
                && (changeID || changeAddress || !firstName.equals(newFirstName) || !lastName.equals(newLastName))) {
            return false;
        }

        if (isUnder18 && changeAddress)
            return false;

        if (changeID && (personID.charAt(0) - '0') % 2 == 0)
            return false;

        if (!isValidPersonID(newID) || !isValidAddress(newAddress) || !isValidDate(newBirthdate))
            return false;
    ...
    public String addDemeritPoints(String offenseDateStr, int points) {
        ...
        // Instruction: If the above conditions and any other conditions you may want to
        // consider are met, the demerit points for a person should be inserted into the
        // TXT file,
        // and the addDemeritPoints function should return "Success". Otherwise, the
        // addDemeritPoints function should return "Failed".
